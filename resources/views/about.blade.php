...
<html lang="en">
<head>
	<title>About Members Portal</title>
	<meta charset="utf-8">
...
<body>
	<div class="container">
						...
						<div class="panel panel-default">
							<div class="panel-heading" role="tab" id="heading1">
								<h3 class="accordion_headers">
									<a class="accordion_links" data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="false" aria-controls="collapse1">Technologies Utilized ></a>
								</h3>
							</div>
					...
					<div id="accordion2" role="tablist" aria-multiselectable="false">
						<div class="panel panel-default">
							<div class="panel-heading" role="tab" id="heading2">
								<h3 class="accordion_headers">
									<a class="accordion_links" data-toggle="collapse" data-parent="#accordion2" href="#collapse2" aria-expanded="false" aria-controls="collapse2">The Developers and Backstory ></a>
								</h3>
							</div>
		...
		<div class="row about_page">
			<div class="col-xs-10 col-sm-10 col-md-7 col-lg-7 col-xl-7 col-xs-offset-1 col-sm-offset-1 col-md-offset-1 col-lg-offset-1 col-xl-offset-1">
			...
			<div class="col-xs-10 col-sm-10 col-md-3 col-lg-3 col-xl-3 about_div">
				<h3 class="about_page2">News &amp; Announcements</h3>
		...
		<div class="row about_page">
			...
			<div class="col-xs-10 col-sm-10 col-md-3 col-lg-3 col-xl-3 about_div">
				<h3 class="about_page2">Events &amp; Requests for Proposals (RFPs)</h3>
		...
		<div class="row about_page">
			...
			<div class="col-xs-10 col-sm-10 col-md-3 col-lg-3 col-xl-3 about_div">
				<h3 class="about_page2">Company Profiles</h3>
		...
		<div class="row about_page">
			...
			<div class="col-xs-10 col-sm-10 col-md-3 col-lg-3 col-xl-3 about_div">
				<h3 class="about_page2">Member Dashboard</h3>
		...
		<div class="row about_page">
			...
			<div class="col-xs-10 col-sm-10 col-md-3 col-lg-3 col-xl-3 about_div">
				<h3 class="about_page2">Account Personalization</h3>
		...
		<div class="row about_page">
			...
			<div class="col-xs-10 col-sm-10 col-md-3 col-lg-3 col-xl-3 about_div">
				<h3 class="about_page2">Admin Dashboard</h3>
