		...
		<div class="home_panel">
			<h3 class="text-center">Navigation</h3>
				...
				<ul>
					...
					<li>
						<a href="{{ action('UsersController@deleteUserSearch') }}" alt="Delete User">Delete User</a>
					</li>
				</ul>
				<ul>
					<p>Carousels</p>
					...
					<li>
						<a href="{{ action('CarouselsController@editgeneral') }}" alt="Edit Carousel">Edit Carousel Item</a>
					</li>
				</ul>
				<ul>
					<p>Org Event</p>
					...
					<li>
						<a href="{{ action('EventsController@editgeneral') }}" alt="Edit Org Event">Edit Org. Event</a>
					</li>
				</ul>
				<ul>
					<p>RFPs</p>
