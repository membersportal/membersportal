@foreach ($rfps as $key => $rfp)
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
			...
			<p class="rfp_contact">Contact: <span class="rfp_contact_detail">{{ $rfp->contact_name }}</span>&nbsp;&nbsp; || &nbsp;&nbsp;Dept: <span class="rfp_contact_detail">{{ $rfp->contact_department }}</span>&nbsp;&nbsp; || &nbsp;&nbsp;Phone:</span> <span class="rfp_contact_detail">{{ '(' . substr($rfp->contact_no, 0, 3) . ') ' . substr($rfp->contact_no, 3, 3) . '-' . substr($rfp->contact_no, 6, 4) }}</span></p>
