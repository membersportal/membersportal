<!-- full_name, title -->
	<div class="form-group half_width">
		...
		<input type="text" class="form-control" name="full_name" value="{{ old('full_name') }}" placeholder="John Doe" maxlength="100" required>
		@include ('partials.error', ['value' => 'full_name'])
	</div>
	<div class="form-group half_width">
		<label for="title">Lask Name</label>
		<input type="text" class="form-control" name="title" value="{{ old('title')}}" placeholder="COO" maxlength="100" required>
	...
	<div class="form-group">
		...
		<input type="url" class="form-control" name="linkedin_url" value="{{ old('linkedin_url') }}" placeholder="https://www.linkedin.com/in/anthony-martinez">
