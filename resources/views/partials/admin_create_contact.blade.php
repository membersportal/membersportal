...
<div class="form-group">
	...
	<input type="text" class="form-control" name="city" value="{{ $contact->city }}" maxlength="50">
	@include ('partials.error', ['value' => 'city'])
</div>
@include ('partials.state', ['contact' => $contact])
<div class="form-group">
	<label for="zip">Zip</label>
	<input type="number" class="form-control" name="zip" value="{{ $contact->zip }}" placeholder="10101" maxlength="5">
...
<div class="form-group">
	...
	<input type="number" class="form-control" name="phone_no" value="{{ $contact->phone_no }}" placeholder="5554567890" maxlength="10">
