...
class EventsTableSeeder extends Seeder
{
		...
		public function run()
		{
			$events = [
				...
				['company_id' => 1, 'industry_id' => '14', 'title' =>	'List Makers: An After Hours Event', 'desc' =>	"Join SABJ at Top Golf for an evening of networking and golf and meet the executives of San Antonio's top companies included in the San Antonio Business Journal's 2016 lists.", 'from_date' =>	'2016-09-28', 'to_date' => '2016-09-28', 'invite_only' => False, 'rsvp_required' => True, 'url' => 'hhttp://www.bizjournals.com/sanantonio/event/142902/2016/list-makers-an-after-hours-event', 'img' => 'listmakers.jpeg'],
